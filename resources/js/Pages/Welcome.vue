            ...
            <section class="bg-white border-b py-4">
              <div class="container max-w-5xl mx-auto m-8">
                ...
                <div class="flex flex-wrap">
                  <div>
                      <div class="w-5/6 shadow rounded bg-lime-50 border sm:w-5/6 my-1">
                    <div class="flex flex-wrap">
                      <div class="w-1/6 sm:w-1/6">
                        <img
                          src="http://127.0.0.1:8000/images/shop_09.jpg"
                          class="w-fit h-48"
                        />
                      </div>
                      <div class="w-5/6 sm:w-5/6">
                        <h3
                          class="
                            p-4
                            pb-0
                        ...
                        <p class="px-4 pb-2">
                          By <i>tauseedzaman</i> on <i>12, Dec, 2030</i>
                        </p>
                        <p class="px-4">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Alias cupiditate voluptate, cum adipisci
                          repellat hic culpa nostrum labore, nam quis quasi a
                          reprehenderit odio sint reiciendis dicta. Aliquid,
                          fuga provident?
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="w-0 bg-red-600 sm:w-1/6 ">
                    <h3
